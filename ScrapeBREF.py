#code from https://github.com/parth1902/Scrape-FBref-data/blob/master/Scrape_FBref.ipynb
# data from FBREF
#standard(stats)
...
df_port_outfield=get_outfield_data('https://fbref.com/en/comps/22/','/Major-League-Soccer-Stats')

df_port_outfield.to_csv('MLS2021_Outfield.csv',index=False)

print(df_port_outfield.head())
#This cell is to get the goalkeeper data for any competition

#Go to the 'Standard stats' page of the league
#For Premier League 2019/20, the link is this: https://fbref.com/en/comps/9/stats/Premier-League-Stats
#Remove the 'stats', and pass the first and third part of the link as parameters like below
df_keeper = get_keeper_data('https://fbref.com/en/comps/22/','/Major-League-Soccer-Stats')

#Save csv file to Desktop
df_keeper.to_csv('MLS2021_keepers.csv',index=False)

print(df_keeper.head())
